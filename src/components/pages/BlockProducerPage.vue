<template>
  ...
  <div v-else>
    <v-layout class="mb-12" row wrap>
      <v-flex xs10 sm10 md10 lg8 xl6 offset-xs1 offset-sm1 offset-md1 offset-lg2 offset-xl3>
        <v-layout row wrap>
          <v-flex xs12 sm8 md4 lg10 xl10 offset-sm2 offset-md1 offset-lg1 offset-xl1>
            <v-card
                v-if="
                  ...
                  <template v-for="(comment, index) in comments">
                    ...
                    <v-list-item v-if="blockProducer.user">
                      ...
                      >
                        <v-list-item-title
                          class="mb-1"
                          style="font-weight: 500; font-size:0.9em; color:#343747;"
                        >
